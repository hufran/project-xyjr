...
ractive.on('withDrawSubmit', function (e) {
            ...
            $.ajax({
                ...
                success: function(res){
                    if (res.status == 0) {
                        ...
                        // console.log(ractive.get('action'))
                        // window.document.forms[0].action=res.data;
                        // console.log("window.form.action:",window.document.forms[0].action);
